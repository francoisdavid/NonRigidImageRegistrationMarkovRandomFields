% Function called by the computeLabeling function which calculates the energy of a given label
%  at a certain possition depending on the image I and J and the current displacement field.
